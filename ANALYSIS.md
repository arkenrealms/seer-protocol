...
- Completed leaf analysis for `src/modules/oasis`.
- Added maintainer docs:
  - `src/README.md`, `src/ANALYSIS.md`
  - `src/modules/README.md`, `src/modules/ANALYSIS.md`
  - `src/modules/oasis/README.md`, `src/modules/oasis/ANALYSIS.md`
...
## Next chunk
- Deepest-first: `src/modules/isles` leaf analysis/docs, then bubble up with protocol test recommendations.
