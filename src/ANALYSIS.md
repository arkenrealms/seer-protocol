...
- Local module contract strictness (e.g., Oasis) directly impacts transport reliability assumptions upstream.
...
- [ ] Continue deepest-first analysis for remaining module leaves and roll findings up into `packages/protocol/ANALYSIS.md`.