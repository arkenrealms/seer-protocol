...
- Isles/Infinite resolver safety logic is now centralized in `methodResolver.ts` to reduce drift between modules and keep saveRound-only compatibility fallback behavior aligned.
