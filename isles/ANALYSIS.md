...
- Router now enforces Isles-first own-property handler resolution with method-matched Evolution fallback and deterministic `TRPCError` when neither service exposes callable handlers.
