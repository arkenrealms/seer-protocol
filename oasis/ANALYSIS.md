...
- `getScene` now guards non-object `input.data` before reading `applicationId`, preventing null/primitive payload crashes while schema tightening is still pending.
