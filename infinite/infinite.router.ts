      ...
      .mutation(({ input, ctx }) => {
        ...
        if (typeof method !== 'function') {
          throw new TRPCError({
            ...
            message: 'Evolution.saveRound handler is unavailable for Infinite.saveRound',
          });
        }
    ...
    interact: t.procedure
      ...
      .mutation(({ input, ctx }) => {
        ...
        if (typeof method !== 'function') {
          throw new TRPCError({
            code: 'INTERNAL_SERVER_ERROR',
            message: 'Evolution.interact handler is unavailable for Infinite.interact',
          });
        }
        return method.call(evolutionService, input, ctx);
      }),
    ...
    getScene: t.procedure
      ...
      .mutation(({ input, ctx }) => {
        ...
        if (typeof method !== 'function') {
          throw new TRPCError({
            code: 'INTERNAL_SERVER_ERROR',
            message: 'Evolution.getScene handler is unavailable for Infinite.getScene',
          });
        }
        return method.call(evolutionService, input, ctx);
      }),
